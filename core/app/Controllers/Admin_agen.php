...
class Admin_agen extends BaseController
{
    ...
    {
        return view('Admin_agen/v_admin_agen.php');
    }
    ...
    public function create()
    {
        if (session('username') == null) {
            ...
            return view('Admin_agen/create', $data);
        }
    }
    ...
    public function save()
    {
        if (session('username') == null) {
            ...
            if (!$this->validate([
                ...
                return redirect()->to(base_url() . '/Admin_agen/create')->withInput();
            }
            ...
            return redirect()->to(base_url() . '/Admin_agen');
        }
    }
    public function detail($kategori)
    {
        if (session('username') == null) {
            ...
            return view('Admin_agen/detail', $data);
        }
    }
    ...
    public function update($kategori)
    {
        if (session('username') == null) {
            ...
            if (!$this->validate([
                ...
                return redirect()->to(base_url() . '/Admin_agen/' . $kategori)->withInput();
            }

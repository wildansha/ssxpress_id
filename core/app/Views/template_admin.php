...
<head>
    ...
    <!-- <script src="https://kit.fontawesome.com/fda6b5862e.js" crossorigin="anonymous"></script> -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse  " id="collapsibleNavbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-auto">
                            <a href="<?php echo base_url('admin_sosmed'); ?>" class="nav-link" style="color: black;">Sosmed</a>
                        </li>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <form id="form_alamat_dn" autocomplete="off">
                    <input type="text" name="fakefield" autocomplete="nope" style="display:none">
                    ...
                    <textarea required name="detail_alamat_penerima" class="form-control" oninput="auto_grow(this)" placeholder="Nomor rumah, warna pagar, dll"></textarea>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                ...
                <select required name="negara" id="negara" class="form-control w-100">
                ...
                <p class="judul_input">Penerima</p>
                <input type="text" name="penerima" class="form-control" placeholder="Andi, Budi dll">
...
<div class="container mt-3">
    <div class="card shadow my-2">
        ...
        <div class="card-body">
            <button class="btn btn-success" style="font-weight: bold;" onclick="open_modal_add_alamat_dn()">+ Alamat Dalam Negeri</button>
            <button class="btn btn-primary" style="font-weight: bold;" onclick="open_modal_add_alamat_ln()">+ Alamat Luar Negeri</button>

    ...
    <div class="card-body p-1">
        <div class="row ">
            <div class="col-2 d-flex justify-content-center align-items-center px-0">
                <input type="radio" class="form-control ml-2" name="alamat" value="dn_<?= $id ?>" style="width: 24px;">
            </div>
            <div class="col-10 pl-0">
                ...
                <hr class="my-1">
                <p class="mb-0" style="font-size: 12px !important;text-align: left;"><?= $alamat . ", " . $kecamatan . ", " . $kabupaten  . ", " . $provinsi ?></p>
            </div>
        </div>
    </div>
</div>